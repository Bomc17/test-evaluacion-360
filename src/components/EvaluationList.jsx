...
const EvaluationList = ({ evaluations, setEvaluations, handleEvaluationClick, selectedEvaluation, handleFormSubmit }) => {
  ...
  return (
    <div className="card">
      ...
      <div className="card-content">
        ...
        {selectedEvaluation && (
          <EvaluationForm initialData={selectedEvaluation} onSubmit={handleFormSubmit} />
        )}
      </div>
    </div>
  );
